...
public class AchievementManager : MonoBehaviour
{
    ...
    public void UpdateAchievementUI()       //업적 UI업데이트 함수
    {
        ...
        foreach(AchievementData achievement in allAchievements)     //데이터 저장
        {
    ...
    void SaveAchievements()     //데이터 저장
    {
        ...
        {
            PlayerPrefs.SetInt("Unlocked " + achievement.name, achievement.isUnlocked ? 1 : 0);
        }
        PlayerPrefs.Save();
    }
    ...
    void LoadAchievements()     //데이터 로드
    {
        ...
        foreach (AchievementData achievement in allAchievements)
        {
            achievement.isUnlocked = PlayerPrefs.GetInt("Unlocked " + achievement.name, 0) == 1;
        }
    }
    ...
    void ShowAchievementPopup(AchievementData achievement)       //업적팝업 표시
    {
